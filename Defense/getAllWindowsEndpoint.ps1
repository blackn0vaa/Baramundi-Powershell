...
# Definiert die Basis-URL für die API-Anfrage, die alle Windows-Endpunkte abruft
$BaseURL = $serverUrl + "/bconnect/defensecontrol/v2.0/BitLocker/WindowsEndpoints?OrderBy=EndpointName&PageSize=1000"
